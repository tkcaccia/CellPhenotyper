process RUN_KODAMA_ANALYSIS {
    ...
    publishDir "${params.outdir_base}/08_kodama/${sample_id}", mode: (params.publish_dir_mode ?: 'rellink'), overwrite: true
    publishDir "${params.outdir_base}/08_kodama_logs/${sample_id}", mode: (params.publish_dir_mode ?: 'rellink'), overwrite: true, pattern: "*.Rout"
